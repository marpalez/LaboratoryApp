...
/// </para>
/// <para>
/// <b>Esto solo dice cuál es la buena; quien la reparte es
/// <see cref="RepartoDelPrograma"/>.</b> Durante un tiempo esto fue todo lo que había, y
/// el resultado era un cartel sin salida: los demás equipos leían «hay una versión más
/// nueva» y no tenían de dónde sacarla. Por eso <c>version.json</c> se escribe
/// <b>el último</b>, cuando los ficheros ya están puestos.
/// </para>
/// </summary>
